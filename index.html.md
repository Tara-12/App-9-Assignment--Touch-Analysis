...
<!-- The following code has been developed by students and/or researchers of the Freshman Research Initiative, DIY Diagnostics Stream at The University of Texas at Austin.  This code is shared for demonstration purposes and should not be considered a product -- it is for entertainment purposes only.  Any user of this code does so at their own risk. Members of the DIY Stream, FRI, and The University of Texas system are not liable for anything related to this code.
  ...
  Load an image onto a canvas and do image analysis 
    ...
    if (file.type.match(imageType)) {
      ...
      reader.onload = function(e) {
        ...
        img.onload = function() {
          ...
          drawImageIOSFix(context2,img, 0, 0, img.naturalWidth, img.naturalHeight, 0, 0, 600, 500); //rearranged order of functions and variables
          //got rid of bracket here
          //inserted new variable for image 2 and inserted drawImage function in Javascript section
          //changed img2 in draw image function in Javascript to img and changed context to context2
          
          var img2= context2.getImageData(0, 0, 600, 500); //changed date to data and added a semicolon
          var data= img2.data; //added variable for image data
          //got rid of "function" in front of drawImageIOSFix
          ...
          //inserted color variables
          //data [i]= 0 means no red
          //data [i+1] = 0 means no green
          
          context2.putImageData (img2, 0, 0);
          //insert function that will put the image data onto image 2 and replace the pixels
         
         //got rid of comments around stuff functions and variables I added
 ...
 <body>
  <div data-role="page">
    ...
    <div data-role="content">	
      ...
      <script> /* This script initiates the cavas and puts the text on the canvas "myCanvas" */
        var canvas2 = document.getElementById('dataCanvas'); //inserted 2nd canvas and renamed variables
        var context2 = canvas2.getContext("2d");
        context2.font = '20pt Calibri'; //changed everything from context to context2 and from canvas to canvas2
        context2.fillStyle = "black";
        context2.fillText("Adjusted image", 10, 20);
      </script>
